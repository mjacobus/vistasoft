...
describe Vistasoft::Soap::Models::Property, "#attributes" do
  ...
  context "delegated attributes" do
    Vistasoft::Soap::Models::Property::ATTRIBUTES.each do |attribute|
...
describe Vistasoft::Soap::Models::Property, "#initialize" do
  Vistasoft::Soap::Models::Property::ATTRIBUTES.each do |attribute|
